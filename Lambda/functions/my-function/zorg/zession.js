// const AmazonCognitoIdentity = require('amazon-cognito-identity-js') // May use later
// const AWS = require('aws-sdk'); // May use later
const base64url = require('base64url')
// const CognitoUserPool = AmazonCognitoIdentity.CognitoUserPool; // May use later
const fetch = require('node-fetch')
// global.fetch = require('node-fetch');
const jtp = require('jwk-to-pem')
const jwt = require('jsonwebtoken')
// const request = require('request'); // May use later
